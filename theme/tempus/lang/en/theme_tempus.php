 ...
 *
 * @package   theme_tempus
 * @copyright 2012 Bas Brands, www.basbrands.nl
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['pluginname'] = 'Tempus';
$string['privacy:metadata'] = 'The tempus theme does not store any personal data about any user.';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';

$string['choosereadme'] = '
<div class="clearfix"><div class="theme_screenshot"><h2>Tempus</h2>
